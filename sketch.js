...
function handlePlayerArrowCollision() {
  for (var i = 0; i < playerArrows.length; i++) {
    ...
    if (
     ...
     if(baseCollision.collided || computerCollision.collided || archerCollision.collided){
...
function handleComputerArrowCollision() {
  for (var i = 0; i < computerArrows.length; i++) {
    ...
    if (
      ...
      if(baseCollision.collided || playerCollision.collided || archerCollision.collided){
